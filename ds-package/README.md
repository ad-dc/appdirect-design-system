...
```bash
npm install https://github.com/ad-dc/appdirect-design-system/releases/download/v0.2.7/appdirect-ds-prototype-kit-0.2.7.tgz
```
...
```bash
npm install /path/to/appdirect-ds-prototype-kit-0.2.7.tgz
```
